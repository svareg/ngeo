...
var defaultImageLoadFunction_ = ol_source_Image_js__WEBPACK_IMPORTED_MODULE_6__["defaultImageLoadFunction"];
...
var exports = function (_olObservable) {
  ...
  _proto.sourceImageWMSToTileWMS = function sourceImageWMSToTileWMS(source, projection) {
    if (source instanceof ol_source_ImageWMS_js__WEBPACK_IMPORTED_MODULE_7__["default"] && source.getUrl() && source.getImageLoadFunction() === defaultImageLoadFunction_) {
